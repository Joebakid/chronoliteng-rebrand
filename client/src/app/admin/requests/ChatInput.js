    ...
    <div className="border-t border-[var(--border)] p-4 bg-[var(--surface-strong)]/50">
      <div className="flex items-center gap-3 bg-[var(--surface)] rounded-full border border-[var(--border)] p-1.5 pl-4 focus-within:border-[var(--accent)] transition-all shadow-sm">
        ...
        <input
          ...
          /* CRITICAL FIX: font-size 16px (text-base) stops mobile browsers 
             from zooming in when the input is focused. 
          */
        ...
        <button
          ...
          className="h-10 w-10 flex items-center justify-center rounded-full bg-[var(--foreground)] text-[var(--surface-strong)] hover:scale-105 active:scale-95 disabled:opacity-20 transition shadow-md shrink-0"
        >
          {sending ? (
